...
const typingStyles = css`
  ...
  white-space: nowrap;
  overflow: hidden;
  border-right: 0.15em solid #15b9fe;
  animation:
      ...
      <ModalContent>
        ...
        <ModalBody>
          <Text color="black" mb={4}>
            Unlock the full potential of Artificial Life Coach by signing up or
            logging in.
          </Text>
          <Box backgroundColor="gray.50" borderRadius="md" p={4}>
            ...
            <List spacing={2}>
              ...
              <ListItem>
                <ListIcon as={CheckIcon} color="quaternary" />A customizable
                diary
              </ListItem>
              <ListItem>
                <ListIcon as={CheckIcon} color="quaternary" />A free experience
              </ListItem>
            </List>
          </Box>
        </ModalBody>
        <ModalFooter justifyContent="flex-start">
          <Text
            color="black"
            css={isSmallScreen ? undefined : typingStyles}
            fontWeight="bold"
          >
