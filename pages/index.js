...
export default function Home() {
  ...
  const displayButton = useBreakpointValue({
    base: "block",
    md: "block",
    lg: "none",
    xl: "none",
  });
  const footerDirection = useBreakpointValue({
    base: "column",
    md: "column",
    lg: "row",
  });
  ...
  return (
    <GradientBox borderRadius="md" p={4}>
                ...
                <DrawerContent>
                  ...
                  <DrawerBody>
                    <Flex direction="column">
                      <Heading onClick={() => setCurrentView("agenda")}>
                        My amazing week
                      </Heading>
                      <Heading onClick={() => setCurrentView("interests")}>
                        My interests
                      </Heading>
                      <Heading onClick={() => setCurrentView("coach")}>
                        Consult the coach
                      </Heading>
                    </Flex>
                  </DrawerBody>
      ...
      <LegalNoticesModal
        isOpen={isLegalNoticesOpen}
        onClose={closeLegalNotices}
      />
      <PrivacyPolicyModal
